...
export default function Ejercicio3Resultado({ route, navigation }) {
  const { titulo, resultado, formula, unidad } = route.params;
  return (
    <View style={styles.container}>
      <Text style={styles.label}>Formula aplicada (Spinner):</Text>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#fff', borderRadius: 12, padding: 24, alignItems: 'center', width: '100%', elevation: 3, marginBottom: 28 },
